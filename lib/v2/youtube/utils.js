    ...
    getPlaylistItems: (id, part, cache) =>
        cache.tryGet(
            ...
            () => {
                ...
                return youtubeUtils.getAllPlaylistItems(id, part);

            },
            config.cache.routeExpire,
            false
        ),
    getAllPlaylistItems: async (id, part, nextPageToken) => {
        ...
        if (res.data.nextPageToken) {
            const next = await youtubeUtils.getAllPlaylistItems(id, part, res.data.nextPageToken);
